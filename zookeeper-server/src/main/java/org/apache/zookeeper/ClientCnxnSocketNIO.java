...
public class ClientCnxnSocketNIO extends ClientCnxnSocket {
    ...
    void doIO(List<Packet> pendingQueue, ClientCnxn cnxn)
      throws InterruptedException, IOException {
        ...
        //可以读的
        //套路 incomingBuffer 先是4的大小，读len，然后incomingBuffer在变成len，查看是否读满，读满说明一个包完整
        if (sockKey.isReadable()) {
        ...
        }if (sockKey.isWritable()) { //当前的网络连接可以写的
            //获取packet
            ...
            if (outgoingQueue.isEmpty()) {
                ...
                disableWrite();
                //如果发现outgoingQueue是空的，取消对OPWRITE的关注
                //否则select会一直返回OPWRITE
            } else {
                // Just in case
                enableWrite();
            }
    ...
    throws IOException {
        //NIO线程持有这个对象ClientCnxnSocketNIO，这里是NIO线程做的
